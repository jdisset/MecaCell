...
class Camera : public QObject {
 ...
 public slots:
	...
	QVector3D getUpVector() { return upVector.normalized(); }
	QVector3D getViewVector() { return viewVector.normalized(); }
	QVector3D getRightVector() { return QVector3D::crossProduct(viewVector, upVector).normalized(); }
