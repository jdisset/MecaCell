...
void main(){
	...
	vec3 reducedColor = mix(surfaceColor+vec3(0.1),vec3((surfaceColor - 0.65)*1.17+0.5) ,max(0.0,min(0.8,diffuseCoef*diffuseCoef))) ; // dégradé couleur clair sur les bords -> sombre au centre. Effet "translucide"
